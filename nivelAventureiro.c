...
int main(){
    ...
    printf("| CARTA N1 |\n");
    printf("|----------|\n");
    printf("|-Estado: %s\n|-Codigo: %s\n|-Cidade: %s\n|-populacao: %d habitantes\n|-Area: %0.2f km2\n|-PIB: %0.2f R$\n|-Numero de pontos turisticos: %d\n|-Densidade populacional: %0.2f hab/km2\n|-PIB per capita: %0.2fR$",
        carta1.estado,carta1.idCarta,carta1.cidade,carta1.pop,carta1.area,carta1.PIB,carta1.nTuristicos,carta1.densidadePOP,carta1.PIBper);
    printf("\n");
    printf("|----------|\n");
    printf("| CARTA N2 |\n");
    printf("|----------|\n");
    printf("|-Estado: %s\n|-Codigo: %s\n|-Cidade: %s\n|-populacao: %d habitantes\n|-Area: %0.2f km2\n|-PIB: %0.2f R$\n|-Numero de pontos turisticos: %d\n|-Densidade populacional: %0.2f hab/km2\n|-PIB per capita: %0.2f R$",
        carta2.estado,carta2.idCarta,carta2.cidade,carta2.pop,carta2.area,carta2.PIB,carta2.nTuristicos,carta2.densidadePOP,carta2.PIBper);
    printf("\n");
    printf("---------------------------------\n");
